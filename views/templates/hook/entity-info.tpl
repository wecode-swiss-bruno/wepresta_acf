{**
 * ACF - Entity Info Hook Template (Generic)
 * Displays custom fields on any entity page front-office
 *}
{if $acf_fields && count($acf_fields) > 0}
<div class="acf-entity-info acf-entity-info--{$acf_entity_type|escape:'html':'UTF-8'}" id="acf-entity-info-{$acf_entity_type|escape:'html':'UTF-8'}-{$acf_entity_id|intval}">
