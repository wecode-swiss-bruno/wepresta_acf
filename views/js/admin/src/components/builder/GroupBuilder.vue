...
import GroupSettings from '@/components/builder/GroupSettings.vue'
import LocationRulesEditor from '@/components/builder/LocationRulesEditor.vue'
import DocumentationPanel from '@/components/builder/DocumentationPanel.vue'
