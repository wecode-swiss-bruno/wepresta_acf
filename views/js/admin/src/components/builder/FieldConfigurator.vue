...
import TextFieldConfig from '@/components/builder/config/TextFieldConfig.vue'
import TextareaFieldConfig from '@/components/builder/config/TextareaFieldConfig.vue'
import NumberFieldConfig from '@/components/builder/config/NumberFieldConfig.vue'
import EmailFieldConfig from '@/components/builder/config/EmailFieldConfig.vue'
import UrlFieldConfig from '@/components/builder/config/UrlFieldConfig.vue'
import SelectFieldConfig from '@/components/builder/config/SelectFieldConfig.vue'
import CheckboxFieldConfig from '@/components/builder/config/CheckboxFieldConfig.vue'
import RadioFieldConfig from '@/components/builder/config/RadioFieldConfig.vue'
import BooleanFieldConfig from '@/components/builder/config/BooleanFieldConfig.vue'
import DateFieldConfig from '@/components/builder/config/DateFieldConfig.vue'
import TimeFieldConfig from '@/components/builder/config/TimeFieldConfig.vue'
import DatetimeFieldConfig from '@/components/builder/config/DatetimeFieldConfig.vue'
import ColorFieldConfig from '@/components/builder/config/ColorFieldConfig.vue'
import RichTextFieldConfig from '@/components/builder/config/RichTextFieldConfig.vue'
import FileFieldConfig from '@/components/builder/config/FileFieldConfig.vue'
import ImageFieldConfig from '@/components/builder/config/ImageFieldConfig.vue'
import VideoFieldConfig from '@/components/builder/config/VideoFieldConfig.vue'
import GalleryFieldConfig from '@/components/builder/config/GalleryFieldConfig.vue'
import FilesFieldConfig from '@/components/builder/config/FilesFieldConfig.vue'
import RelationFieldConfig from '@/components/builder/config/RelationFieldConfig.vue'
import ListFieldConfig from '@/components/builder/config/ListFieldConfig.vue'
import RepeaterFieldConfig from '@/components/builder/config/RepeaterFieldConfig.vue'
...
function generateUniqueSlug(baseSlug: string, excludeUuid?: string): string {
  const existingSlugs = store.currentGroup?.fields
    ?.filter((f: any) => f.uuid !== excludeUuid && f.slug)
    ?.map((f: any) => f.slug) || []
    ...
    <template v-else>
      ...
      <div v-if="needsSaving" class="acfps-save-field-bar">
        ...
        >
          ...
          <span v-else>{{ t('saveField') }}</span>
        </button>
        <small class="text-muted ml-2">{{ t('fieldNotSaved') }}</small>
      </div>
      ...
      <div class="config-content">
        ...
        <template v-if="activeTab === 'presentation'">
          <div class="acfps-form-section">
            <div class="form-group">
              <label class="form-control-label">{{ t('showTitle') }}</label>
              <PsSwitch
                v-if="localField && localField.foOptions"
                v-model="localField.foOptions.showTitle as boolean"
                id="field-show-title"
                @update:model-value="onFieldChange"
              />
              <small class="form-text text-muted">
            ...
            <div class="form-group">
              <label class="form-control-label">{{ t('valueTranslatable') }}</label>
              <PsSwitch
              ...
              />
              <small class="form-text text-muted">
                {{ t('valueTranslatableHelp') }}
              </small>
              <small v-if="!currentFieldType?.supportsTranslation" class="form-text text-warning">
                {{ t('translationNotSupported') }}
              </small>
            </div>

            <div class="form-group">
              <label class="form-control-label">{{ t('customClass') }}</label>
              <input
                v-if="localField && localField.foOptions"
            ...
            <div class="form-group">
              <label class="form-control-label">{{ t('customId') }}</label>
              <input
                v-if="localField && localField.foOptions"
