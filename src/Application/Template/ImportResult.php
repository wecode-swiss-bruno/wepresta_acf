...
final class ImportResult
{
    ...
    public function isSuccess(): bool { return $this->success && empty($this->errors); }
    ...
    public function getFieldsImported(): int { return $this->fieldsImported; }
    ...
    public function addCreated(string $slug): self { $this->created[] = $slug; return $this; }
    public function addUpdated(string $slug): self { $this->updated[] = $slug; return $this; }
    public function addSkipped(string $slug, string $reason): self { $this->skipped[$slug] = $reason; return $this; }
    public function addError(string $slug, string $error): self { $this->errors[$slug] = $error; $this->success = false; return $this; }
    public function addWarning(string $warning): self { $this->warnings[] = $warning; return $this; }
    public function addFieldsImported(int $count): self { $this->fieldsImported += $count; return $this; }
