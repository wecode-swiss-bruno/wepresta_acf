...
class AcfField
{
    ...
    public function getGroup(): ?AcfGroup { return $this->group; }
    public function setGroup(?AcfGroup $group): self { $this->group = $group; return $this; }
    public function getParent(): ?AcfField { return $this->parent; }
    public function setParent(?AcfField $parent): self { $this->parent = $parent; return $this; }
    /** @return Collection<int, AcfField> */
    public function getChildren(): Collection { return $this->children; }

    public function addChild(AcfField $child): self
    {
    ...
    public function removeChild(AcfField $child): self
    {
    ...
    public function getConfigValue(string $key, mixed $default = null): mixed { return $this->config[$key] ?? $default; }
    /** @return array<string, mixed>|null */
    ...
    public function isRequired(): bool { return (bool) ($this->validation['required'] ?? false); }
    /** @return array<string, mixed>|null */
    public function getConditions(): ?array { return $this->conditions; }
    /** @param array<string, mixed>|null $conditions */
    public function setConditions(?array $conditions): self { $this->conditions = $conditions; return $this; }
    /** @return array<string, mixed>|null */
    public function getWrapper(): ?array { return $this->wrapper; }
    ...
    public function setTranslatable(bool $translatable): self { $this->translatable = $translatable; return $this; }
    ...
    public function getFormOptions(): array
    {
        ...
        if ($this->instructions) { $options['help'] = $this->instructions; }
        if (isset($this->wrapper['class'])) { $options['attr'] = ['class' => $this->wrapper['class']]; }
        return $options;
    }
}
